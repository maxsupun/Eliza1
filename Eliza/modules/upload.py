...
from Eliza import telethn as bot
from Eliza.modules.urluploader import download_file
from Eliza.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By @TheElizaBot",
            )
        except Exception as e:
            traceback.print_exc()
