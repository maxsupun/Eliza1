...
from Eliza import DRAGONS as SUDO_USERS
from Eliza import pbot
from Eliza.modules.sql import forceSubscribe_sql as sql
...
✪ Eliza can mute members who are not subscribed your channel until they subscribe
