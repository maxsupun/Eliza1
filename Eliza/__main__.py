...
from Eliza.modules import ALL_MODULES
from Eliza.modules.helper_funcs.alternate import typing_action
from Eliza.modules.helper_funcs.chat_status import is_user_admin
...
Support them  [Youtube](https://www.youtube.com/channel/UCLziWEeJ-VZuUnZaFUIYTOA?sub_confirmation=1)"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Eliza.modules." + module_name)
...
@run_async
def Eliza_about_callback(update, context):
    query = update.callback_query
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"*😍 Hi again!  The name's {dispatcher.bot.first_name} 😍 \n\nAs  You I'm a next generational group management bot developed by Ezila Team.* "
            f"\n\n 🔥 Join [Ezila](https://t.me/ElizaBotUpdates) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [InfinityJE](https://t.me/ElizaBotUpdates).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            text=f"*{dispatcher.bot.first_name} Is the redisigned version of Eliza and Naruto for the best performance.*"
            f"\n\nBased on [Eliza](https://github.com/maxsupun/Eliza) "
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        Eliza_about_callback, pattern=r"aboutmanu_"
    )
