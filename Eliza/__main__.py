...
from Eliza.modules.system_stats import bot_sys_stats
...
BUTTONS = [
    ...
    [
        InlineKeyboardButton(
            text="Sᴜᴘᴘᴏʀᴛ", url="https://t.me/ElizaSupport"),
    ],
...
MENU = [
    [
     ...
     [
        InlineKeyboardButton(
            text="Uᴘᴅᴀᴛᴇs", url ="https://t.me/Eliza_updates"),
    ],
    [
        InlineKeyboardButton(
            text="➕️ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ ➕️", url="http://t.me/Max123robot?startgroup=true"),
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Updates", url ="https://t.me/Eliza_updates")]],
            ),
        )
...
def Eliza_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Bᴜɢ'ꜱ🐞", url="https://t.me/ElizaSupport"
                        ),
                        InlineKeyboardButton(
                            text="Updates💁‍♀️", url="https://t.me/Eliza_updates"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="https://t.me/ElizaSupport"),
                    InlineKeyboardButton(text="Uᴘᴅᴀᴛᴇꜱ", url="https://t.me/Eliza_updates"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="aboutmanu_howto"),
        ...
        query.message.edit_text(
            ...
            f"\n Here you can find information about the bots I coded and the people who helped me create Eliza"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Eliza", url="https://t.me/SL_Tech_Worldchat"),
